...
(let
  ...
  (custom-theme-set-faces
   ...
   `(highlight   ((,class (:background ,zenburn-hl-line))))
   ...
   `(font-lock-comment-delimiter-face    ((,class (:foreground ,zenburn-comment))))
   `(font-lock-constant-face             ((,class (:foreground ,zenburn-constant :weight bold))))
   `(font-lock-doc-face                  ((,class (:foreground ,zenburn-macro :weight bold))))
   `(font-lock-doc-string-face           ((,class (:foreground ,zenburn-constant :weight bold))))
   `(font-lock-function-name-face        ((,class (:foreground ,zenburn-function))))
   `(font-lock-keyword-face              ((,class (:foreground ,zenburn-keyword :weight bold))))
   `(font-lock-negation-char-face        ((,class (:foreground ,zenburn-specialkey))))
   ...
   `(custom-button                  ((,class (:foreground ,zenburn-specialkey :background ,zenburn-wildmenu-bg :weight bold :underline t))))
   `(custom-button-mouse            ((,class (:foreground ,zenburn-wildmenu-fg :background ,zenburn-wildmenu-bg :weight bold :underline t))))
   `(custom-button-pressed          ((,class (:foreground ,zenburn-warning-fg :background ,zenburn-warning-bg :weight bold :underline t))))
   `(custom-button-pressed-unraised ((,class (:foreground ,zenburn-error-fg :background ,zenburn-error-bg :weight bold :underline t))))
   ...
   `(custom-invalid                 ((,class (:foreground ,zenburn-error-fg :background ,zenburn-error-bg :weight bold))))
   `(custom-rogue                   ((,class (:foreground ,zenburn-error-fg :background ,zenburn-error-bg :weight bold))))
   ...
   `(gnus-summary-normal-unread ((,class (:foreground ,zenburn-normal-fg :weight bold))))
   `(gnus-summary-selected      ((,class (:foreground ,zenburn-structure :weight bold :underline nil))))
   ...
   `(message-header-name       ((,class (:foreground ,zenburn-label :weight normal :underline t))))
   `(message-header-newsgroups ((,class (:foreground ,zenburn-macro :weight bold))))
   ...
   `(wl-highlight-folder-path-face                   ((,class (:weight bold :underline nil))))
   `(wl-highlight-folder-unknown-face                ((,class (:foreground ,zenburn-errormsg :weight bold))))
   `(wl-highlight-folder-unread-face                 ((,class (:foreground ,zenburn-normal-fg :weight bold))))
   `(wl-highlight-folder-zero-face                   ((,class (:foreground ,zenburn-comment :weight normal))))
   ...
   `(wl-highlight-message-header-contents            ((,class (:foreground ,zenburn-comment :slant italic))))
   `(wl-highlight-message-headers                    ((,class (:foreground ,zenburn-keyword :weight bold))))
   `(wl-highlight-message-important-header-contents  ((,class (:foreground ,zenburn-title :weight bold))))
   `(wl-highlight-message-important-header-contents2 ((,class (:foreground ,zenburn-specialcomment :weight bold))))
   `(wl-highlight-message-signature                  ((,class (:foreground ,zenburn-macro :weight bold))))
   `(wl-highlight-summary-displaying-face            ((,class (:foreground ,zenburn-structure :weight bold :underline nil))))
   `(wl-highlight-summary-disposed-face              ((,class (:foreground ,zenburn-nontext))))
   `(wl-highlight-summary-new-face                   ((,class (:foreground ,zenburn-normal-fg :weight bold))))
   ...
   `(wl-highlight-summary-unread-face                ((,class (:foreground ,zenburn-normal-fg :weight bold))))
